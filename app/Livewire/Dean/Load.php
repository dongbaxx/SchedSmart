...
class Load extends Component
{
    ...
    /**
     * Build one printable "LOADS" sheet for the logged-in Dean (iyang own teaching loads).
     */
    private function buildSheets(): void
    {
        ...
        // Filter: loads assigned sa Dean (as faculty)
        if ($useCOFaculty) {
    ...
    {
        return view('livewire.dean.load', [   // re-use nato imong existing Blade
            'sheets'      => $this->sheets,
