<div class="space-y-6">
  <div class="flex items-center justify-between">
    ...
    <a href="{{ route('registrar.specialization.create') }}" class="rounded-lg bg-emerald-600 text-white px-3 py-2 text-sm">Add Specialization</a>
  </div>
        ...
        @forelse ($items as $row)
          <tr>
            ...
            <td class="px-3 py-2 text-right">
              <a href="{{ route('registrar.specialization.edit', $row) }}"
               wire:navigate
