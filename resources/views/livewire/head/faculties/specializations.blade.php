...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <input
                ...
                class="flex-1 min-w-[200px] rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            >

            @if ($user->course_id)
                {{-- View only this course --}}
                <button
                    type="button"
        ...
        <p class="text-xs text-gray-500">
            @if ($user->course_id)
                ...
                @else
                    ...
                    Click
                    <span class="font-semibold">“View only {{ $courseName }} specializations”</span>
                    to hide other courses.
                @endif
            @else
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        ...
        @php
            $current = $user->specializations()->orderBy('name')->pluck('name')->all();
        @endphp
        @if(count($current))
