{{-- resources/views/livewire/dean/people/index.blade.php --}}
...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between gap-3">
    <div>
      ...
      <div class="text-sm text-gray-500">
        Heads & Faculty under your department only. Filter by role/course, then manage attributes.
      </div>
    </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
    ...
    <div>
      <select
        ...
        class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
      >
        <option value="">All roles (Head & Faculty)</option>
        @foreach($roles as $r)
  ...
  {{-- table (mirrors registrar: has Department, Course, Emp Reg/Extra, actions) --}}
  <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
    <table class="min-w-full text-sm">
      ...
      <tbody class="divide-y divide-gray-100">
        ...
        @empty
          <tr>
            <td class="px-4 py-6 text-center text-gray-500" colspan="7">No users found.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
