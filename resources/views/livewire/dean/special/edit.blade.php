<div class="space-y-6">
  <div class="flex items-center justify-between">
    <h1 class="text-xl font-semibold text-emerald-900">Edit Specialization</h1>
    <a href="{{ route('dean.special.index') }}" class="text-sm text-gray-600 hover:underline">Back</a>
  </div>
